...
public class LinkFastAddFragment extends BaseSmartLinkFragment implements OnClickListener{
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		String wifiName = getActivity().getSharedPreferences(Config.FILE, Context.MODE_PRIVATE).getString(Config.WIFINAME, "");
		String wifiPwd = getActivity().getSharedPreferences(Config.FILE, Context.MODE_PRIVATE).getString(Config.WIFIPWD, "");
		// 显示已经连接的wifi名称
...
//			String password = sp.getString(apSsid, "no");
			if(wifiPwd.equals("")){
				...
				passwordEditText.setText(wifiPwd);
			}
		} 
