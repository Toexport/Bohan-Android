 ...
 * 类说明：设备所有用电数据查询
 */
public class MainInfoFragment2 extends BaseFragment implements OnClickListener {
	/**********DECLARES*************/
	...
	private AllDeviceDayDataFragment2 allDeviceDayDataFragment;
	private AllDeviceMonthDataFragment2 allDeviceMonthDataFragment;
	private AllDeviceYearDataFragment2 allDeviceYearDataFragment;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		view =inflater.inflate(R.layout.fragment_main_info2, null);
		/**********初始化控件*************/
		...
		allDeviceDayDataFragment = new AllDeviceDayDataFragment2();
		allDeviceMonthDataFragment = new AllDeviceMonthDataFragment2();
		allDeviceYearDataFragment = new AllDeviceYearDataFragment2();
