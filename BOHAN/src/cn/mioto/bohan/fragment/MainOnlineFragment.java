 ...
 * 
 */
public class MainOnlineFragment extends BaseUDPNoCurrentFragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.fragment_main_list, null);
		...
		if (NetworkUtils.isNetworkConnected(getActivity())) {
			new Thread() {
				public void run() {
					...
					try {
						HttpUtils.TOKIN = "";
						String result = WebServiceClient.CallWebService("GetPosNameList",null,getActivity());
				...
				public void run() {
					...
					try {
						...
						String result = WebServiceClient
								.CallWebService("GetLoadNameList",null,getActivity()); 
						Log.d("resultLogin", result);
						if (result != null) {
							appTypesList.clear();
							JSONObject obj = new JSONObject(result);
