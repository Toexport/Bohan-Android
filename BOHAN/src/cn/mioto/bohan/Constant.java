...
public class Constant {
	...
	public static long REFRESH_ONLINE = 4000;//控制继电器后刷新的间隔
	...
	//
	public static final String MENUNOWDATACTIVITY = "MENUNOWDATAaCTIVITY";
	
	public static String BROCAST_ONLINE_MSG="online";//在線列表
	public static String BROCAST_ONLINE_ON_OFF_MSG="online_on_off";//在線列表开关操作
	public static String BROCAST_FAILE_MSG = "faile";//失败
	public static String BROCAST_NOW_DATA_MSG = "now_data";//实时数据
	public static String BROCAST_UNTIPIRCE_MSG = "price_menxian";//查询单价负荷门限
	public static String BROCAST_SET_DAIJI_DUANDIAN = "set_daiduan";//设置待机断电或不断电
	public static String BROCAST_SAVE_DAIJI_DUANDIAN = "save_daiduan";//保存单价和负荷门限 
	public static String BROCAST_GET_DAIJI_TIME = "daiji_time";//读取设备待机断电延时时间(开关无此项)
	public static String BROCAST_SET_DAIJI_TIME = "set_daiji_time";//设置设备待机断电延时时间(开关无此项)
	public static String BROCAST_GET_TIME_JILIANG = "get_ding_shi_ji_liang";//查询定时计量数据
	public static String BROCAST_SET_TIME_JILIANG = "set_ding_shi_ji_liang";//设置定时计量数据
	public static String BROCAST_GET_9TIME = "get_9time";//查询9组继电器通断时间
	public static String BROCAST_SET_9TIME = "set_9time";//设置9组继电器通断时间
	public static String BROCAST_COUNT_DOWN = "get_count_down";//查询倒计时信息
	public static String BROCAST_COUNT_DOWN_OPEN = "count_down_open";//倒计时開
	public static String BROCAST_COUNT_DOWN_CLOSE = "count_down_close";//倒计时关
	public static String BROCAST_ALL_OPEN_OR_CLOSE = "all_open_or_close";//全开全关
	public static String BROCAST_SOCKET_FAIL = "socket_fail";//socket连接失败
	public static String BROCAST_TIME_OUT = "time_out";//超时
	public static int SEND_FAIL =100;//socket发送失败
	public static String SOCKET_SEND_FAIL ="socket_send_fail";//socket发送失败
}
