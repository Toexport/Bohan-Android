 ...
 * 
 */
public class CustomBarChartViewMonth extends BaseChartView implements Runnable{
	...
	public CustomBarChartViewMonth(Context context) {
		super(context);
//		initView();
	}

	public CustomBarChartViewMonth(Context context, AttributeSet attrs){   
		super(context, attrs);   
//		initView();
	}

	public CustomBarChartViewMonth(Context context, AttributeSet attrs, int defStyle) {
