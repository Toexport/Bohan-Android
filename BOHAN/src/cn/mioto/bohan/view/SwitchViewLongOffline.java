...
* 
*/
public class SwitchViewLongOffline extends View{
	...
	public SwitchViewLongOffline(Context context) {
		this(context, null);
	}

	public SwitchViewLongOffline(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		int heightSize = (int) (widthSize * 0.48f);//调节长度
	...
	public void setOnStateChangedListener(cn.mioto.bohan.view.SwitchViewLongOffline.OnStateChangedListener onStateChangedListener) {
		if (onStateChangedListener == null) throw new IllegalArgumentException("empty listener");
