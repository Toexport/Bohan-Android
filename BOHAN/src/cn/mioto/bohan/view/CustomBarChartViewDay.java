 ...
 * 
 */
public class CustomBarChartViewDay extends BaseChartView implements Runnable{
	...
	public CustomBarChartViewDay(Context context) {
		super(context);
		//		initView();
	}

	public CustomBarChartViewDay(Context context, AttributeSet attrs){   
		super(context, attrs);   
		//		initView();
	}

	public CustomBarChartViewDay(Context context, AttributeSet attrs, int defStyle) {
