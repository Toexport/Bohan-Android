...
public class DateTimePicker extends WheelPicker {
	...
	public DateTimePicker(Activity activity, @Mode int mode) {
		...
		yearLabel = activity.getString(R.string.year1);
		monthLabel = activity.getString(R.string.month1);
		dayLabel = activity.getString(R.string.day1);
		hourLabel = activity.getString(R.string.hour3);
		minuteLabel = activity.getString(R.string.min2);
	}
