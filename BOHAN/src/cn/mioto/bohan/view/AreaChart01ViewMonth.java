 ...
 * 类说明：区域图
 */
public class AreaChart01ViewMonth extends BaseChartView implements Runnable{
	...
	private List<Double> dataSeries2;

	public AreaChart01ViewMonth(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		//		initView();
	}	 

	public AreaChart01ViewMonth(Context context, AttributeSet attrs){   
		super(context, attrs);   
		//		initView();
	}

	public AreaChart01ViewMonth(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * @throws
	 */
	public void setBarColor(List<String> xLables){
...
//			chart.setCrurveLineStyle(XEnum.CrurveLineStyle.BEELINE);
			...
			//数据轴最大值
			chart.getDataAxis().setAxisMax(Constant.CHART_AREA_MONTH_DEFAULT_MAX);
			//数据轴刻度间隔
			chart.getDataAxis().setAxisSteps(Constant.CHART_AREA_MONTH_DEFAULT_MAX/5);
