package cn.mioto.bohan.view.pulltorefresh;
...
public class MaterialRefreshLayout extends FrameLayout {
    ...
    private MaterialHeaderView mMaterialHeaderView;//头
    ...
    private void init(Context context, AttributeSet attrs, int defstyleAttr) {
        ...
        waveColor = t.getColor(R.styleable.MaterialRefreshLayout_wave_color,Color.TRANSPARENT);
