...
public class NineSetSetTimeActivity extends BaseCheckDataMenuActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ViewUtil.setToolbarTitle(getString(R.string.time_select));
		/***************************************************/
	...
	public void onClick(View v) {
		if(v==llClickSelectTime1){
			...
			picker.setOnTimePickListener(new TimePicker.OnTimePickListener() {
				...
				public void onTimePicked(String hour, String minute) {
					...
					if(Integer.valueOf(startHour)>Integer.valueOf(endHour)){
						ToastUtils.shortToast(NineSetSetTimeActivity.this, getString(R.string.end_input_time_error));
			...
			if(Integer.valueOf(startHour)>Integer.valueOf(endHour)){
				...
				//把符合协议格式的数据传递
				if(!(getSelectedResult().equals(getString(R.string.please_select_start_end_time))||getSelectedResult().equals(getString(R.string.please_select_week)))){
					...
					finish();
				}else if(getSelectedResult().equals(getString(R.string.please_select_start_end_time))){
					ToastUtils.shortToast(NineSetSetTimeActivity.this, getString(R.string.please_select_start_end_time));
				}else if(getSelectedResult().equals(getString(R.string.please_select_week))){
					LogUtilNIU.value("*****请选择星期提示返回");
					ToastUtils.shortToast(NineSetSetTimeActivity.this, getString(R.string.please_select_week));
				};
	...
	private String getSelectedResult(){
		...
		if(startTime.equals("0000")&&endTime.equals("0000")){
			return getString(R.string.please_select_start_end_time);
		}
		//得到结束时间
		...
		if(b.toString().equals("00000000")){
			...
			return getString(R.string.please_select_week);
		}
