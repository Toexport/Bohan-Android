...
import cn.mioto.bohan.fragment.SingleDeviceDayDataFragment2;
import cn.mioto.bohan.fragment.SingleDeviceMonthDataFragment;
import cn.mioto.bohan.fragment.SingleDeviceMonthDataFragment2;
import cn.mioto.bohan.fragment.SingleDeviceYearDataFragment;
import cn.mioto.bohan.fragment.SingleDeviceYearDataFragment2;
...
public class MenuSingleDeviceSumActivity extends BaseCheckDataMenuActivity {
	...
	private Handler h = new Handler() {// 另一个hanlder
		public void handleMessage(Message msg) {
			...
			if (msg.what == Constant.MSG_SUCCESS) {
				...
				progressGettingDataDismiss(getString(R.string.update_data_fail));
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		singleDeviceDayDataFragment = new SingleDeviceDayDataFragment2();
		singleDeviceMonthDataFragment = new SingleDeviceMonthDataFragment2();
		singleDeviceYearDataFragment = new SingleDeviceYearDataFragment2();
...
//		receiveThread.start();
	...
	private void refreshDayData() {
		((SingleDeviceDayDataFragment2) singleDeviceDayDataFragment)
				.checkDataAndUpdateCharts();
	}

	private void refreshYearData() {
		((SingleDeviceYearDataFragment2) singleDeviceYearDataFragment)
				.checkDataAndUpdateCharts();
	}

	private void refreshMonthData() {
		((SingleDeviceMonthDataFragment2) singleDeviceMonthDataFragment)
