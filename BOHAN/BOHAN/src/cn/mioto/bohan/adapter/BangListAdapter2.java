 ...
 * 类说明：设备列表的adapter
 */
public class BangListAdapter2 extends BaseAdapter {
	// 填充数据的list
	List<SingleDevice> deviceList = new ArrayList<>();
	Context context;
	LayoutInflater inflater;
	MainListBangFragment2 listfragment;
	...
	public BangListAdapter2(Context context,List<SingleDevice> datas,MainListBangFragment2 listfragment ){
...
//								ToastUtils.shortToast(context, "网络不给力");
//							}
//						});
						
						//删除设备
						listfragment.delDevices(singleDevice);
