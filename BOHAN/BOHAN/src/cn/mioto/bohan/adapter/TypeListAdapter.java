...
public class TypeListAdapter extends BaseAdapter {
	...
	protected void setToControl(String i, String type) {
		...
		int length = ("13570856740;" + "LoadName;"+ type + ";" + i).length();
		final String message = "3A" + "100200" + length + "13570856740;" + "LoadName;"
				+ type + ";" + i + "0D";// 0001
...
//		new Enterface("batchSendToDevice.act").addParam("appliancesort", type)
