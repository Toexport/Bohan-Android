 ...
 *
 */
public class DropDownMenuTextView extends LinearLayout{
...
//    }
    ...
    public String getEditTextContent() {
		return mTvMenuTitles.get(0).getText().toString();//获得editText内容
	}
    /**
     * @Title: getEditTextContent 
	...
	public void setEditTextContent(String title) {
		mTvMenuTitles.get(0).setText(title);
	}
    ...
    public DropDownMenuTextView(Context mContext) {
        super(mContext);
        init(mContext);
    }

    public DropDownMenuTextView(Context mContext, AttributeSet attrs) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDrawable) {
            ...
            for (int i = 0; i < mMenuCount; i++) {
                final LinearLayout v = (LinearLayout) LayoutInflater.from(mContext).inflate(R.layout.menu_item_tvkind, null, false);
                ...
                if (mDefaultMenuTitle==null||mDefaultMenuTitle.length==0){
                	tv.setText(mMenuItems.get(i)[0]);//设置默认的显示
                }else{
