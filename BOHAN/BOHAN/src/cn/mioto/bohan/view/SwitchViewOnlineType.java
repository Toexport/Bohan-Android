 ...
 * 创建时间：2016年6月8日 下午14:03:59 
 */
public class SwitchViewOnlineType extends View {
	...
	public SwitchViewOnlineType(Context context) {
		this(context, null);
	}

	public SwitchViewOnlineType(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		int heightSize = (int) (widthSize * 0.52f);
