...
//		webView1.loadUrl("http://blog.csdn.net/developer_jiangqq/article/details/7054762");
	...
	public void onPause() {
		super.onPause();
		MobclickAgent.onPageEnd("伯瀚网页页"); // （仅有Activity的应用中SDK自动调用，不需要单独写）保证 onPageEnd 在onPause 之前调用,因为 onPause 中会保存信息。"SplashScreen"为页面名称，可自定义
